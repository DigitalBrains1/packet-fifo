...
module soc_system_mm_interconnect_7 (
	...
	soc_system_mm_interconnect_7_router router (
	...
	soc_system_mm_interconnect_7_router_001 router_001 (
	...
	soc_system_mm_interconnect_7_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                                           //       clk.clk
		.reset              (f2sdram_only_master_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_7_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                                      //       clk.clk
		.reset               (hps_0_f2h_sdram0_data_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_7_cmd_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                                      //       clk.clk
		.reset              (hps_0_f2h_sdram0_data_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_7_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                                           //       clk.clk
		.reset               (f2sdram_only_master_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_7_avalon_st_adapter #(
		.inBitsPerSymbol (258),
		.inUsePackets    (0),
		.inDataWidth     (258),
		.inChannelWidth  (0),
