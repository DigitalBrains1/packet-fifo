...
module soc_system_mm_interconnect_3 (
	...
	wire   [31:0] fifo_h2f_in_in_agent_m0_address;                                            // fifo_h2f_in_in_agent:m0_address -> fifo_h2f_in_in_translator:uav_address
	...
	wire  [108:0] fifo_h2f_in_in_agent_rf_source_data;                                        // fifo_h2f_in_in_agent:rf_source_data -> fifo_h2f_in_in_agent_rsp_fifo:in_data
	...
	wire  [108:0] fifo_h2f_in_in_agent_rsp_fifo_out_data;                                     // fifo_h2f_in_in_agent_rsp_fifo:out_data -> fifo_h2f_in_in_agent:rf_sink_data
	...
	wire          cmd_mux_003_src_valid;                                                      // cmd_mux_003:src_valid -> fifo_h2f_in_in_agent:cp_valid
	wire  [107:0] cmd_mux_003_src_data;                                                       // cmd_mux_003:src_data -> fifo_h2f_in_in_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                      // fifo_h2f_in_in_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [8:0] cmd_mux_003_src_channel;                                                    // cmd_mux_003:src_channel -> fifo_h2f_in_in_agent:cp_channel
	wire          cmd_mux_003_src_startofpacket;                                              // cmd_mux_003:src_startofpacket -> fifo_h2f_in_in_agent:cp_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                                // cmd_mux_003:src_endofpacket -> fifo_h2f_in_in_agent:cp_endofpacket
	...
	wire   [31:0] fifo_f2h_out_in_csr_agent_m0_address;                                       // fifo_f2h_out_in_csr_agent:m0_address -> fifo_f2h_out_in_csr_translator:uav_address
	...
	wire  [108:0] fifo_f2h_out_in_csr_agent_rf_source_data;                                   // fifo_f2h_out_in_csr_agent:rf_source_data -> fifo_f2h_out_in_csr_agent_rsp_fifo:in_data
	...
	wire  [108:0] fifo_f2h_out_in_csr_agent_rsp_fifo_out_data;                                // fifo_f2h_out_in_csr_agent_rsp_fifo:out_data -> fifo_f2h_out_in_csr_agent:rf_sink_data
	...
	wire          cmd_mux_004_src_valid;                                                      // cmd_mux_004:src_valid -> fifo_f2h_out_in_csr_agent:cp_valid
	wire  [107:0] cmd_mux_004_src_data;                                                       // cmd_mux_004:src_data -> fifo_f2h_out_in_csr_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                      // fifo_f2h_out_in_csr_agent:cp_ready -> cmd_mux_004:src_ready
	wire    [8:0] cmd_mux_004_src_channel;                                                    // cmd_mux_004:src_channel -> fifo_f2h_out_in_csr_agent:cp_channel
	wire          cmd_mux_004_src_startofpacket;                                              // cmd_mux_004:src_startofpacket -> fifo_f2h_out_in_csr_agent:cp_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                                // cmd_mux_004:src_endofpacket -> fifo_f2h_out_in_csr_agent:cp_endofpacket
	...
	wire   [31:0] fifo_f2h_out_out_agent_m0_address;                                          // fifo_f2h_out_out_agent:m0_address -> fifo_f2h_out_out_translator:uav_address
	...
	wire  [108:0] fifo_f2h_out_out_agent_rf_source_data;                                      // fifo_f2h_out_out_agent:rf_source_data -> fifo_f2h_out_out_agent_rsp_fifo:in_data
	...
	wire  [108:0] fifo_f2h_out_out_agent_rsp_fifo_out_data;                                   // fifo_f2h_out_out_agent_rsp_fifo:out_data -> fifo_f2h_out_out_agent:rf_sink_data
	...
	wire          cmd_mux_005_src_valid;                                                      // cmd_mux_005:src_valid -> fifo_f2h_out_out_agent:cp_valid
	wire  [107:0] cmd_mux_005_src_data;                                                       // cmd_mux_005:src_data -> fifo_f2h_out_out_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                      // fifo_f2h_out_out_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [8:0] cmd_mux_005_src_channel;                                                    // cmd_mux_005:src_channel -> fifo_f2h_out_out_agent:cp_channel
	wire          cmd_mux_005_src_startofpacket;                                              // cmd_mux_005:src_startofpacket -> fifo_f2h_out_out_agent:cp_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                                // cmd_mux_005:src_endofpacket -> fifo_f2h_out_out_agent:cp_endofpacket
	...
	wire    [8:0] cmd_mux_006_src_channel;                                                    // cmd_mux_006:src_channel -> button_pio_s1_agent:cp_channel
	...
	wire    [8:0] cmd_mux_008_src_channel;                                                    // cmd_mux_008:src_channel -> led_pio_s1_agent:cp_channel
	...
	wire          fifo_h2f_in_in_agent_rp_valid;                                              // fifo_h2f_in_in_agent:rp_valid -> router_005:sink_valid
	wire  [107:0] fifo_h2f_in_in_agent_rp_data;                                               // fifo_h2f_in_in_agent:rp_data -> router_005:sink_data
	wire          fifo_h2f_in_in_agent_rp_ready;                                              // router_005:sink_ready -> fifo_h2f_in_in_agent:rp_ready
	wire          fifo_h2f_in_in_agent_rp_startofpacket;                                      // fifo_h2f_in_in_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          fifo_h2f_in_in_agent_rp_endofpacket;                                        // fifo_h2f_in_in_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire          fifo_f2h_out_in_csr_agent_rp_valid;                                         // fifo_f2h_out_in_csr_agent:rp_valid -> router_006:sink_valid
	wire  [107:0] fifo_f2h_out_in_csr_agent_rp_data;                                          // fifo_f2h_out_in_csr_agent:rp_data -> router_006:sink_data
	wire          fifo_f2h_out_in_csr_agent_rp_ready;                                         // router_006:sink_ready -> fifo_f2h_out_in_csr_agent:rp_ready
	wire          fifo_f2h_out_in_csr_agent_rp_startofpacket;                                 // fifo_f2h_out_in_csr_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          fifo_f2h_out_in_csr_agent_rp_endofpacket;                                   // fifo_f2h_out_in_csr_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire          fifo_f2h_out_out_agent_rp_valid;                                            // fifo_f2h_out_out_agent:rp_valid -> router_007:sink_valid
	wire  [107:0] fifo_f2h_out_out_agent_rp_data;                                             // fifo_f2h_out_out_agent:rp_data -> router_007:sink_data
	wire          fifo_f2h_out_out_agent_rp_ready;                                            // router_007:sink_ready -> fifo_f2h_out_out_agent:rp_ready
	wire          fifo_f2h_out_out_agent_rp_startofpacket;                                    // fifo_f2h_out_out_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          fifo_f2h_out_out_agent_rp_endofpacket;                                      // fifo_f2h_out_out_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire          fifo_h2f_in_in_agent_rdata_fifo_src_valid;                                  // fifo_h2f_in_in_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] fifo_h2f_in_in_agent_rdata_fifo_src_data;                                   // fifo_h2f_in_in_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire          fifo_h2f_in_in_agent_rdata_fifo_src_ready;                                  // avalon_st_adapter_003:in_0_ready -> fifo_h2f_in_in_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_003_out_0_valid;                                          // avalon_st_adapter_003:out_0_valid -> fifo_h2f_in_in_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                                           // avalon_st_adapter_003:out_0_data -> fifo_h2f_in_in_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                                          // fifo_h2f_in_in_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                                          // avalon_st_adapter_003:out_0_error -> fifo_h2f_in_in_agent:rdata_fifo_sink_error
	wire          fifo_f2h_out_in_csr_agent_rdata_fifo_src_valid;                             // fifo_f2h_out_in_csr_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] fifo_f2h_out_in_csr_agent_rdata_fifo_src_data;                              // fifo_f2h_out_in_csr_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire          fifo_f2h_out_in_csr_agent_rdata_fifo_src_ready;                             // avalon_st_adapter_004:in_0_ready -> fifo_f2h_out_in_csr_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_004_out_0_valid;                                          // avalon_st_adapter_004:out_0_valid -> fifo_f2h_out_in_csr_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                                           // avalon_st_adapter_004:out_0_data -> fifo_f2h_out_in_csr_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                                          // fifo_f2h_out_in_csr_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                                          // avalon_st_adapter_004:out_0_error -> fifo_f2h_out_in_csr_agent:rdata_fifo_sink_error
	wire          fifo_f2h_out_out_agent_rdata_fifo_src_valid;                                // fifo_f2h_out_out_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] fifo_f2h_out_out_agent_rdata_fifo_src_data;                                 // fifo_f2h_out_out_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire          fifo_f2h_out_out_agent_rdata_fifo_src_ready;                                // avalon_st_adapter_005:in_0_ready -> fifo_f2h_out_out_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_005_out_0_valid;                                          // avalon_st_adapter_005:out_0_valid -> fifo_f2h_out_out_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_005_out_0_data;                                           // avalon_st_adapter_005:out_0_data -> fifo_f2h_out_out_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_005_out_0_ready;                                          // fifo_f2h_out_out_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire    [0:0] avalon_st_adapter_005_out_0_error;                                          // avalon_st_adapter_005:out_0_error -> fifo_f2h_out_out_agent:rdata_fifo_sink_error
	...
	soc_system_mm_interconnect_3_router_005 router_006 (
	...
	soc_system_mm_interconnect_3_cmd_mux_003 cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_3_cmd_mux_003 cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_3_rsp_demux_003 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_3_rsp_demux_003 rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
