	soc_system u0 (
		...
		.fifo_h2f_out_mm_external_interface_write       (<connected-to-fifo_h2f_out_mm_external_interface_write>),       //                                   .write
		.fifo_h2f_out_mm_external_interface_write_data  (<connected-to-fifo_h2f_out_mm_external_interface_write_data>),  //                                   .write_data
		.fifo_h2f_out_mm_external_interface_acknowledge (<connected-to-fifo_h2f_out_mm_external_interface_acknowledge>), //                                   .acknowledge
		.fifo_h2f_out_mm_external_interface_read_data   (<connected-to-fifo_h2f_out_mm_external_interface_read_data>),   //                                   .read_data
